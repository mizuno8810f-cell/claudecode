...
- `images/bedroom_present_zoom.png`  （プレゼント(拡大) state:closed）
- `images/bedroom_present_zoom__open.png`  （プレゼント(拡大) state:open）
- `images/present_l_0.png`  （ボタン1 state:0）
- `images/present_l_1.png`  （ボタン1 state:1）
- `images/present_l_2.png`  （ボタン1 state:2）
- `images/present_l_3.png`  （ボタン1 state:3）
- `images/present_l_4.png`  （ボタン1 state:4）
- `images/present_l_5.png`  （ボタン1 state:5）
- `images/present_l_6.png`  （ボタン1 state:6）
- `images/present_l_7.png`  （ボタン1 state:7）
- `images/present_l_8.png`  （ボタン1 state:8）
- `images/present_l_9.png`  （ボタン1 state:9）
- `images/present_r_0.png`  （ボタン2 state:0）
- `images/present_r_1.png`  （ボタン2 state:1）
- `images/present_r_2.png`  （ボタン2 state:2）
- `images/present_r_3.png`  （ボタン2 state:3）
- `images/present_r_4.png`  （ボタン2 state:4）
- `images/present_r_5.png`  （ボタン2 state:5）
- `images/present_r_6.png`  （ボタン2 state:6）
- `images/present_r_7.png`  （ボタン2 state:7）
